...
const CsvTaskStatus = () => {
    ...
    const onGetAllCsvHandler = async (id) => {
        ...
        try {
            const response = await API_NODE.get(`${window.SERVER_IP}/getcsvinfo/${id}`,
                {
                    headers: {
                        token: token,
                    },
    ...
    const onGetAllTaskStatusHandler = async () => {
        ...
        try {
            const response = await API_NODE.post(`${window.SERVER_IP}/gettaskstatusdetails/${selectedCsvId}`,
                {
